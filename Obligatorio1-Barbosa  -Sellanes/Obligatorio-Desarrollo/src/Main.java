...
public class Main {
    ...
    static void agregarJugador(List<Jugador> jugadores)
    {
        ...
        String posicion = scanner.nextLine();
            if (posicion=="delantero"||posicion=="defensa" ||posicion=="lateral") {
                _posicion= posicion;

            }else {
                _posicion=null;
                System.out.println("Solo se admite delantero,defensa o lateral");
        ...
        jugadores.add(new Jugador(nombre, apellido, cedula, equipoJ, _posicion, minutosJ));
        System.out.println(" ");
    ...
    static void agregarArbitro(List<Arbitro> arbitros)
    {
        ...
        scanner.nextLine(); // Consumir la nueva línea
        if (cantidadPD>100){
            System.out.println("No se permite ingresar mas de 100 partidos dirigidos");
            cantidadPD=-1;
        }
